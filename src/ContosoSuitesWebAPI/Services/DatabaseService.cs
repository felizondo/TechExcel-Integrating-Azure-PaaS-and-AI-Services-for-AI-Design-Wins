...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings without hotel room")]
    ...
    /// 
    [KernelFunction]
    [Description("Get all bookings by Hotel and MinimumDate.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
          [Description("The ID of the hotel")] int hotelId,   [Description("The Date to look for")] DateTime dt)
    {
